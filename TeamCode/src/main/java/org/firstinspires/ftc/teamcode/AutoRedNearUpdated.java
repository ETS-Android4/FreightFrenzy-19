...
public class AutoRedNearUpdated extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if(opModeIsActive()){
            ...
            navigate.navigate(-40, Constants2020.Direction.STRAIGHT,0, -0.5,backLeft,backRight,frontRight,frontLeft,imu, telemetry, header,true);
            try {
                Thread.sleep(500);
            ...
            navigate.navigate(20, Constants2020.Direction.LEFT,0,0.5,backLeft,backRight,frontRight,frontLeft,imu,telemetry,header,false);
